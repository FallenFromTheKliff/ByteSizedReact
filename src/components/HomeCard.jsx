  ...
  return (
    <div className="inline-flex flex-col items-start h-60 w-100 rounded-lg border border-gray-300 bg-gray-50 hover:shadow-lg duration-300">
      <div className="justify-center items-start space-y-2 px-6 py-4">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-300 font-retro font-bold">
          {props.id}
        </div>
        ...
        <div className="items-center justify-center mt-5">
          <NavLink 
            to={props.path} 
            className="inline-block rounded-lg px-8 py-4 w-full text-center text-white text-xl bg-gray-800 font-retro font-bold hover:bg-black duration-300"
          >
            [ OPEN ACTIVITY ]
          </NavLink>
        </div>
